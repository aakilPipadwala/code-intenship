...
if($_POST)
{
   ...
   $insert= mysqli_query($connect,
           "insert into tbl_product (prod_name,prod_detail,prod_price) values('{$pname}','{$pdetail}','{$pprice}')") or die(mysqli_error($connect));
							...
							<div class="form-body">
                                                            <form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                                                                    <div class="form-group"> 
                                                                        ...
                                                                        <div class="col-sm-9"> 
                                                                            <input type="text" class="form-control" id="inputEmail3" name="pname" placeholder="enter product name" required> </div> 
                                                                    </div> 
                                                                  <div class="form-group"> 
                                                                        <label for="inputEmail3" class="col-sm-2 control-label">PRODUCT DETAIL</label>
                                                                        <div class="col-sm-9"> 
                                                                            <textarea class="form-control" name="pdetail"  required>
                                                                            </textarea>
                                                                        </div> 
                                                                    </div> 
                                                                  <div class="form-group"> 
                                                                        ...
                                                                        <div class="col-sm-9"> 
                                                                            <input type="text" class="form-control" id="inputEmail3"name="pprice" placeholder="enter product price" required> </div> 
                                                                    </div> 
